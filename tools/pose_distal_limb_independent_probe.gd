...
func _init() -> void:
	...
	var pivot: Vector2 = main._topology_socket_position_by_id("hero", unit_bp, nodes, edges, limb_b, "root_joint")
	...
	if not main._start_editor_pose_drag(unit_bp, limb_b, start_local, [limb_b, terminal]):
		_fail("Could not start pose drag for distal limb.")
