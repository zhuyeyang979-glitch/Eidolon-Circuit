...
- Current `main.gd` size is 52,478 lines. The largest remaining functions are `_build_editor_ui` (681 lines), `_apply_editor_panel_visibility` (399), `_resolve_attack` (380), `_compute_unit_stats` (297), and `_refresh_editor_visual_views` (252).
