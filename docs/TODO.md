...
- Define additional scripted arena mechanism effects beyond feature add/remove/restore/mutation, resource pulses, thermal pulses, force pulses, damage pulses, and status pulses.
