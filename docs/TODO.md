...
- Add focused probes for editor preview consumption, destruction invalidation, map-independent saves, and identical replay results inside battle/editor entrypoints.
