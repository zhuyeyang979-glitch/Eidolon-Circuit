...
- Pure state service and `tools/hardware_fault_contract_probe.gd` are implemented, including deterministic pure contact replay; live battle adapter, save round-trip, and live replay probes remain pending.
