...
- Add focused probes for editor preview consumption, authored arena terrain content, combined occlusion integration, destruction invalidation, map-independent saves, and identical replay results inside battle/editor entrypoints.
