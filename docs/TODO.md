...
- Pure `scripts/services/unit_editor_legality_service.gd` baseline is implemented and integrated through `_training_blueprint_illegal_note()`; role identity, explicit socket-size records, custom-topology socket-size records, explicit construct-body manufacturer records, custom-topology manufacturer records, localized messages, hero/puppet/barrier main save/training rejection paths, team validation, and battle-entry legality are covered by `tools/role_identity_software_rejection_probe.gd`, `tools/unit_editor_socket_size_rejection_probe.gd`, `tools/unit_editor_topology_socket_size_gate_probe.gd`, `tools/construct_body_manufacturer_rejection_probe.gd`, `tools/unit_editor_topology_manufacturer_gate_probe.gd`, `tools/unit_editor_legality_main_gate_probe.gd`, `tools/unit_editor_puppet_source_code_main_gate_probe.gd`, `tools/unit_editor_barrier_ether_main_gate_probe.gd`, `tools/unit_editor_legality_team_validation_probe.gd`, and `tools/unit_editor_legality_battle_entry_probe.gd`.
...
- Add broader saved-team load, PVP/AI battle-start, and combined-rule probes before claiming full unit-editor legality completion.
