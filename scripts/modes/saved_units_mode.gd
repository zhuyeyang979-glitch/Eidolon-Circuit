...
func show_intent(focus_path: String, return_context: String, defer_disk_scan: bool, preloaded: bool, loading_queued: bool, reason: String = "saved_units") -> Dictionary:
	var resolved_focus_path := focus_path.strip_edges()
	var resolved_return_context := return_context.strip_edges()
	return {
		"mode_key": MODE_KEY,
		"reason": reason,
		"payload": {"focus_path": resolved_focus_path},
		"focus_path": resolved_focus_path,
		"return_context": resolved_return_context,
